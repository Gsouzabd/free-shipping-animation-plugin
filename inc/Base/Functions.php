...
class Functions{
	...
	*/
	function add_barra_calculo_frete() {
		...
		<div class="texto-barra-calculo" onclick="scrollToCep()"><u>Preencha seu CEP para descobrir quanto falta para seu FRETE GRATIS</u></div>
		...
		<?php
		echo '<script>
			function scrollToCep() {
				var formulario = document.querySelector(".woocommerce-shipping-totals.shipping.page-cart__totals__shipping");
				formulario.scrollIntoView({ behavior: "smooth" });
				if(document.querySelector("a.page-cart__totals__calculator__trigger")){
					document.querySelector("a.page-cart__totals__calculator__trigger").click();
				}
			}
	  	</script>';
	}
